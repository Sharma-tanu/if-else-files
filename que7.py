    ...
    if first_name=="anu" and last_name=="pawar":
        ...
        if date_of_birth ==("18/10/2001"):
            ...
            if gender=="male" or "female":
                print("ok next")
                entre_mobile_number=int(input("enter your moblie number"))
                if enter_mobile_number==("1234567890"):
                    ...
                    if password==(anu@1234):
                        ...
                        if sine_up==("sine up"):
                            ...
                            if password==("yes"):
                                print("ok")
                                code=input("enter the code from your mobil")
                                if code==(12345):
                                    print("confirm")
                                    photo=input("add a profil picture")
                                    if photo==("choos from gallery") or ("take a photo"):
